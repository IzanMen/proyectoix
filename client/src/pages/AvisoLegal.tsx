      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        ...
        <div className="prose-sm text-white/60 space-y-6 leading-relaxed text-sm">
          ...
          <section className="space-y-3">
            ...
            <p>El presente sitio web tiene como objeto facilitar información sobre los servicios de diseño y desarrollo web ofrecidos por IX., así como permitir la suscripción al email diario y el contacto a través de formulario.</p>
          </section>

          <section className="space-y-3">
            <h2 className="text-lg font-display font-semibold text-white/90">3. Propiedad intelectual e industrial</h2>
            <p>Todos los contenidos del sitio web, incluyendo textos, imágenes, diseño gráfico, código fuente, logos y demás elementos, son propiedad de IX. o se utilizan con la debida autorización, y están protegidos por la normativa de propiedad intelectual e industrial.</p>
          ...
          <section className="space-y-3">
            ...
            <p>IX. no se hace responsable de los daños o perjuicios que pudieran derivarse del acceso o uso del sitio web, incluyendo errores u omisiones en los contenidos, falta de disponibilidad del sitio o la transmisión de virus o programas maliciosos.</p>
          </section>

          <section className="space-y-3">
            <h2 className="text-lg font-display font-semibold text-white/90">5. Enlaces externos</h2>
            <p>Este sitio web puede contener enlaces a sitios de terceros. IX. no se responsabiliza del contenido, políticas de privacidad o prácticas de dichos sitios.</p>
          </section>
